<table class="table tablewhite table-invoice table-bordered">
	...
	<tr>
		...
		<td><?=$this->pessoas->getName($orcamento['cliente']);?></td>
...
<table class="table tablewhite equipamento table-bordered">
	...
	<tbody>
		...
		<tr id="equipamento_row<?=$linha['id']?>">
			...
			<td>R$ <span id="equipamento_row<?=$linha['id']?>_diaria"><?=$linha['valordiaria']?></span>,00</td>
			<td id="equipamento_row<?=$linha['id']?>_entrada"><?=$orcamento['dataentrada']?></td>
			<td id="equipamento_row<?=$linha['id']?>_saida"><?=$orcamento['datasaida']?></td>
...
<table class="table tablewhite funcionario table-bordered">
	...
	<tbody>
		...
		<tr id="funcionario_row<?=$linha['id']?>">
			...
			<td>R$ <span id="funcionario_row<?=$linha['id']?>_diaria"><?=$linha['valordiaria']?></span>,00</td>
			<td id="funcionario_row<?=$linha['id']?>_entrada"><?=$orcamento['dataentrada']?></td>
			<td id="funcionario_row<?=$linha['id']?>_saida"><?=$orcamento['datasaida']?></td>
...
<tbody>
	<tr>
		<td class="msg-invoice">
			...
			<p><textarea name="orcamento_obs" id="orcamento_obs" class='obs' value=''><?php if(isset($orcamento['obs'])) echo $orcamento['obs'];?></textarea> </p>
		</td>
		<td class="right">
			<div class="amountdue">
				<h1>
...
<div class="actionBar" align="right">
	...
	echo form_submit( 'back', 'Voltar', 'class="buttonBlue" id="back"' )." ";
	if($do=='add') echo form_submit( 'send', 'Adicionar', 'class="buttonGreen" id="submit"' );
	elseif($do=='edit') echo form_submit( 'send', 'Editar', 'class="buttonOrange" id="submit"' );
	?>
</div>